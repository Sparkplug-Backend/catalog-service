...
import com.sparkplug.catalog.application.dto.modification.ModificationCreateRequestDto;
...
import static com.sparkplug.catalog.presentation.controller.modifications.ModificationsController.MODIFICATIONS_ENDPOINT;

@RestController
@RequestMapping(MODIFICATIONS_ENDPOINT)
public class ModificationsController {

    public static final String MODIFICATIONS_ENDPOINT = "/modifications";
