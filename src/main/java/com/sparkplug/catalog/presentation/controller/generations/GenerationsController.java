...
import com.sparkplug.catalog.application.dto.generation.GenerationCreateRequestDto;
...
import static com.sparkplug.catalog.presentation.controller.generations.GenerationsController.GENERATIONS_ENDPOINT;

@RestController
@RequestMapping(GENERATIONS_ENDPOINT)
public class GenerationsController {

    public static final String GENERATIONS_ENDPOINT = "/generations";
